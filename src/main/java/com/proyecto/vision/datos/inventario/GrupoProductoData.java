...
public class GrupoProductoData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            gruposProductos.add(new GrupoProducto("GPR022307000001", "HOGAR", "ELECTRODOMESTICO", "LINEA BLANCA", "NEVERA", "LG","PUERTA SIMPLE", Constantes.estadoActivo,new CategoriaProducto(1), new CuentaContable(323), new Empresa(2)));
            gruposProductos.add(new GrupoProducto("GPR022307000002", "HOGAR", "ELECTRODOMESTICO", "LINEA GRIS", "TELEVISOR", "SONY","SMART", Constantes.estadoActivo,new CategoriaProducto(1), new CuentaContable(323), new Empresa(2)));
            gruposProductos.add(new GrupoProducto("GPR022307000003", "HOGAR", "MUEBLES", "LINEA CAFE", "DORMITORIOS", "CAMAS", "ZERO FUSION", Constantes.estadoActivo, new CategoriaProducto(1), new CuentaContable(324), new Empresa(2)));
            gruposProductos.add(new GrupoProducto("GPR022307000004", "JUGUETERIA", "NIÑOS", "MOTORIZADOS", "CARROS", "HOT WEELLS","MINIATURA", Constantes.estadoActivo, new CategoriaProducto(1), new CuentaContable(324), new Empresa(2)));
