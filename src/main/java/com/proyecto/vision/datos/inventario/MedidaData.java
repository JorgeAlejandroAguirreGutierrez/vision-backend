...
public class MedidaData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            medidas.add(new Medida("MED202301000002", "UNIDAD", "MITAD", "MIT", Constantes.estadoActivo, new Empresa(1)));
            medidas.add(new Medida("MED202301000003", "UNIDAD", "CUARTO", "CUA", Constantes.estadoActivo, new Empresa(1)));
            medidas.add(new Medida("MED202301000004", "UNIDAD", "CAJAX10", "C10", Constantes.estadoActivo, new Empresa(1)));
            medidas.add(new Medida("MED202301000005", "UNIDAD", "CAJAX12", "C12", Constantes.estadoActivo, new Empresa(1)));
            medidas.add(new Medida("MED202301000006", "UNIDAD", "CAJAX20", "C20", Constantes.estadoActivo, new Empresa(1)));
            medidas.add(new Medida("MED202301000007", "UNIDAD", "SIXPACK", "SIX", Constantes.estadoActivo, new Empresa(1)));
            medidas.add(new Medida("MED202301000008", "UNIDAD", "JABA", "JX12", Constantes.estadoActivo, new Empresa(1)));
            medidas.add(new Medida("MED202301000009", "PESO", "ARROBA", "@", Constantes.estadoActivo, new Empresa(1)));
            medidas.add(new Medida("MED202301000010", "PESO", "GRAMO", "G", Constantes.estadoActivo, new Empresa(1)));
            medidas.add(new Medida("MED202301000011", "PESO", "GRANO", "GRAIN", Constantes.estadoInactivo, new Empresa(1)));
            medidas.add(new Medida("MED202301000012", "PESO", "KILOGRAMO", "KG", Constantes.estadoActivo, new Empresa(1)));
            medidas.add(new Medida("MED202301000013", "PESO", "LIBRA", "LB", Constantes.estadoActivo, new Empresa(1)));
            medidas.add(new Medida("MED202301000014", "PESO", "MILIGRAMO", "MG", Constantes.estadoActivo, new Empresa(1)));
            medidas.add(new Medida("MED202301000015", "PESO", "ONZA", "OZ", Constantes.estadoActivo, new Empresa(1)));
            ...
            medidas.add(new Medida("MED202301000022", "VOLUMEN", "CENTÍMETRO CÚBICO", "CM^3", Constantes.estadoActivo, new Empresa(1)));
            medidas.add(new Medida("MED202301000023", "VOLUMEN", "CUARTO DE GALÓN", "QT", Constantes.estadoActivo, new Empresa(1)));
            ...
            medidas.add(new Medida("MED202301000026", "VOLUMEN", "GALÓN", "GAL", Constantes.estadoActivo, new Empresa(1)));
            medidas.add(new Medida("MED202301000027", "VOLUMEN", "LITRO", "L", Constantes.estadoActivo, new Empresa(1)));
            medidas.add(new Medida("MED202301000028", "VOLUMEN", "METRO CÚBICO", "M^3", Constantes.estadoActivo, new Empresa(1)));
            medidas.add(new Medida("MED202301000029", "VOLUMEN", "TAZA", "CUP", Constantes.estadoActivo, new Empresa(1)));
            ...
            medidas.add(new Medida("MED202301000005", "UNIDAD", "CAJAX12", "C12", Constantes.estadoActivo, new Empresa(2)));
