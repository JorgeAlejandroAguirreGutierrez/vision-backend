    ...
    private IProductoRepository rep;
        ...
        public void run(ApplicationArguments args) throws Exception {
            ...
            if (!ant.isPresent()) {
                ...
                productos.add(new Producto("PRO022306000003", "SERVICIO INFORMATICO", Constantes.no, Constantes.estadoActivo, new CategoriaProducto(2), new GrupoProducto(1), new TipoGasto(1), new Impuesto(2), new Medida(1), new Proveedor(1), new Empresa(2), Collections.emptyList(), Collections.emptyList()));
                productos.add(new Producto("PRO022306000004", "SERVICIO ASEO", Constantes.no, Constantes.estadoActivo, new CategoriaProducto(2), new GrupoProducto(2), new TipoGasto(1), new Impuesto(2), new Medida(1), new Proveedor(1), new Empresa(2), Collections.emptyList(), Collections.emptyList()));
                productos.add(new Producto("PRO022306000005", "INTERESES CORRIENTES", Constantes.no, Constantes.estadoActivo, new CategoriaProducto(2), new GrupoProducto(3), new TipoGasto(1), new Impuesto(2), new Medida(1), new Proveedor(1), new Empresa(2), Collections.emptyList(), Collections.emptyList()));
                productos.add(new Producto("PRO022306000006", "INTERESES POR MORA", Constantes.no, Constantes.estadoActivo, new CategoriaProducto(2), new GrupoProducto(4), new TipoGasto(1), new Impuesto(2), new Medida(1), new Proveedor(1), new Empresa(2), Collections.emptyList(), Collections.emptyList()));
