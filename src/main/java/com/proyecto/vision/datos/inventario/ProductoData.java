    ...
    private IProductoRepository rep;
        ...
        public void run(ApplicationArguments args) throws Exception {
            ...
            if (!ant.isPresent()) {
                ...
                productos.add(new Producto("PRO012307000009", "INTERESES POR MORA", Constantes.no, Constantes.estadoActivo, new CategoriaProducto(2), new GrupoProducto(4), new TipoGasto(1), new Impuesto(2), new Medida(1), new Proveedor(1), new Empresa(1), Collections.emptyList(), Collections.emptyList()));
                //PRODUCTOS PARA EMPRESA 2
                productos.add(new Producto("PRO012307000010", "ARROZ CONEJO", Constantes.no, Constantes.estadoActivo, new CategoriaProducto(1), new GrupoProducto(16), new TipoGasto(1), new Impuesto(2), new Medida(35), new Proveedor(3), new Empresa(2), Collections.emptyList(), Collections.emptyList()));
                productos.add(new Producto("PRO012307000011", "MESA NAPOLITANA", Constantes.no, Constantes.estadoActivo, new CategoriaProducto(1), new GrupoProducto(17), new TipoGasto(2), new Impuesto(4), new Medida(35), new Proveedor(3), new Empresa(2), Collections.emptyList(), Collections.emptyList()));
                //SERVICIOS PARA EMPRESA 2
                productos.add(new Producto("PRO012307000012", "SERVICIO INFORMATICO", Constantes.no, Constantes.estadoActivo, new CategoriaProducto(2), new GrupoProducto(1), new TipoGasto(1), new Impuesto(2), new Medida(1), new Proveedor(1), new Empresa(2), Collections.emptyList(), Collections.emptyList()));
                productos.add(new Producto("PRO012307000013", "SERVICIO ASEO", Constantes.no, Constantes.estadoActivo, new CategoriaProducto(2), new GrupoProducto(2), new TipoGasto(1), new Impuesto(2), new Medida(1), new Proveedor(1), new Empresa(2), Collections.emptyList(), Collections.emptyList()));
                productos.add(new Producto("PRO012307000014", "INTERESES CORRIENTES", Constantes.no, Constantes.estadoActivo, new CategoriaProducto(2), new GrupoProducto(3), new TipoGasto(1), new Impuesto(2), new Medida(1), new Proveedor(1), new Empresa(2), Collections.emptyList(), Collections.emptyList()));
                productos.add(new Producto("PRO012307000015", "INTERESES POR MORA", Constantes.no, Constantes.estadoActivo, new CategoriaProducto(2), new GrupoProducto(4), new TipoGasto(1), new Impuesto(2), new Medida(1), new Proveedor(1), new Empresa(2), Collections.emptyList(), Collections.emptyList()));
