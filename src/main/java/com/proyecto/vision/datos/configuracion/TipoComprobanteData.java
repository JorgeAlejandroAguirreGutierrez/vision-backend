...
public class TipoComprobanteData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            tiposComprobantes.add(new TipoComprobante("TCO000009","NA", "NOTA DE CRÉDITO COMPRA", "N. CRÉDITO COMPRA", "nota_credito_compra", Constantes.no, Constantes.estadoActivo));
            tiposComprobantes.add(new TipoComprobante("TCO000010","NA", "NOTA DE DÉBITO COMPRA", "N. DÉBITO COMPRA", "nota_debito_compra", Constantes.no, Constantes.estadoActivo));
            tiposComprobantes.add(new TipoComprobante("TCO000011","NA", "EGRESO", "EGRESO", "egreso", Constantes.no, Constantes.estadoActivo));
            tiposComprobantes.add(new TipoComprobante("TCO000012","NA", "PEDIDO", "PEDIDO", "pedido", Constantes.no, Constantes.estadoActivo));
            tiposComprobantes.add(new TipoComprobante("TCO000013","NA", "PROFORMA", "PROFORMA", "proforma", Constantes.no, Constantes.estadoActivo));
            tiposComprobantes.add(new TipoComprobante("TCO000014","NA", "ANTICIPO", "ANTICIPO", "recaudacion", Constantes.no, Constantes.estadoActivo));
            tiposComprobantes.add(new TipoComprobante("TCO000015","NA", "RETENCIÓN EN COMPRA", "RETENCIÓN COMPRA", "retencion_compra", Constantes.no, Constantes.estadoActivo));
