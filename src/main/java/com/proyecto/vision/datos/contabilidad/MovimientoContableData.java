...
public class MovimientoContableData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            movimientosContables.add(new MovimientoContable("MVC022308000001", Constantes.estadoActivo, new AfectacionContable(1), new CuentaContable(1),new CuentaContable(2),new CuentaContable(3),new CuentaContable(5), new CuentaContable(6), new CuentaContable(4), new CuentaContable(5), new CuentaContable(1), new Empresa(2)));
            movimientosContables.add(new MovimientoContable("MVC022308000002", Constantes.estadoActivo, new AfectacionContable(1), new CuentaContable(1),new CuentaContable(2),new CuentaContable(3),new CuentaContable(5), new CuentaContable(6), new CuentaContable(4), new CuentaContable(5), new CuentaContable(2), new Empresa(2)));
