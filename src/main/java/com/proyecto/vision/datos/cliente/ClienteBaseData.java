...
public class ClienteBaseData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            clientes.add(new ClienteBase("0603467226", "DELGADO DAQUILEMA", "MARIO RUBEN", null, "CDLA POLITÉCNICA","TRAS EL PARQUE", "CHIMBORAZO", "PENIPE", "PENIPE", "032333333", "0987654321", "master_mds@hotmail.com", Constantes.activo,
