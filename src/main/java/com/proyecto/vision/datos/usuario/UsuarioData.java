...
public class UsuarioData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            //USUARIOS EMPRESA 2
            usuarios.add(new Usuario("USU202301000005", "1303753618", "RECAUDADOR1", "PABLO MARCELO ABAD NIETO", "032948243", "0931248509", "mastermariodelgado@gmail.com", "827ccb0eea8a706c4c34a16891f84e7b", "827ccb0eea8a706c4c34a16891f84e7b", "", avatarBytesMario, Constantes.no, "¿CUAL ES TU MARCA DE VEHICULO PREFERIDO?", "MAZDA", Constantes.estadoActivo, new Perfil(3), new Estacion(8)));
            usuarios.add(new Usuario("USU202301000006", "1706172648", "RECAUDADOR2", "BELLA PILAR ABATA REINOSO", "032945122", "0931248567", "gatosohidalgo@gmail.com", "827ccb0eea8a706c4c34a16891f84e7b", "827ccb0eea8a706c4c34a16891f84e7b", "", avatarBytesJorge, Constantes.no, "¿CUAL ES TU MARCA DE VEHICULO PREFERIDO?", "MAZDA", Constantes.estadoActivo, new Perfil(3), new Estacion(9)));
            usuarios.add(new Usuario("USU202301000007", "0601308661", "AIDITA", "POMAGUALLI PIRAY AYDA ROMELIA", "032945101", "0931248501", "vallauca@gmail.com", "827ccb0eea8a706c4c34a16891f84e7b", "827ccb0eea8a706c4c34a16891f84e7b", "", avatarBytesSantiago, Constantes.no, "¿CUAL ES TU MARCA DE VEHICULO PREFERIDO?", "MAZDA", Constantes.estadoActivo, new Perfil(2), new Estacion(10)));
