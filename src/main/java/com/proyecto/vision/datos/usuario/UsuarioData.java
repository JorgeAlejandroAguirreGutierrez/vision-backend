...
public class UsuarioData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            //USUARIOS EMPRESA 2
            usuarios.add(new Usuario("USU202301000005", "1303753618", "ABAD", "PABLO MARCELO ABAD NIETO", "032948243", "0931248509", "mastermariodelgado@gmail.com", "827ccb0eea8a706c4c34a16891f84e7b", "827ccb0eea8a706c4c34a16891f84e7b", "", avatarBytesMario, Constantes.no, "PRIMERA PREGUNTA", "PRIMERA RESPUESTA", Constantes.estadoActivo, new Perfil(2), new Estacion(8)));
            usuarios.add(new Usuario("USU202301000006", "1706172648", "ABATA", "BELLA PILAR ABATA REINOSO", "032945122", "0931248567", "gatosohidalgo@gmail.com", "827ccb0eea8a706c4c34a16891f84e7b", "827ccb0eea8a706c4c34a16891f84e7b", "", avatarBytesJorge, Constantes.no, "PRIMERA PREGUNTA", "PRIMERA RESPUESTA", Constantes.estadoActivo, new Perfil(2), new Estacion(9)));
            usuarios.add(new Usuario("USU202301000008", "0100967652", "ABRIL", "CARLOS ENRIQUE ABRIL ABRIL", "032945101", "0931248501", "santiago_cantos@hotmail.com", "827ccb0eea8a706c4c34a16891f84e7b", "827ccb0eea8a706c4c34a16891f84e7b", "", avatarBytesSantiago, Constantes.no, "PRIMERA PREGUNTA", "PRIMERA RESPUESTA", Constantes.estadoActivo, new Perfil(3), new Estacion(10)));
            usuarios.add(new Usuario("USU202301000008", "1103037048", "ACARO", "NARCISA LOURDES ACARO CASTILLA", "032945101", "0931248501", "santiago_cantos@hotmail.com", "827ccb0eea8a706c4c34a16891f84e7b", "827ccb0eea8a706c4c34a16891f84e7b", "", avatarBytesSantiago, Constantes.no, "PRIMERA PREGUNTA", "PRIMERA RESPUESTA", Constantes.estadoActivo, new Perfil(3), new Estacion(10)));
