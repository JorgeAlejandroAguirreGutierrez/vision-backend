...
public class ReporteCajaService {
    ...
    public ByteArrayInputStream excel(String apodo, String fechaInicio, String fechaFinal, long empresaId) {
        try {
            ...
            XSSFSheet sheet = workbook.createSheet("REPORTE CAJA");
            ...
            row.createCell(4).setCellValue(reporteCaja.getRazonSocial());
            i++;
            row = sheet.createRow(i);
            row.createCell(4).setCellValue(reporteCaja.getNombreComercial());
            i++;
            row = sheet.createRow(i);
            row.createCell(4).setCellValue(reporteCaja.getNombreReporte());
            i++;
            row = sheet.createRow(i);
            row.createCell(4).setCellValue("FECHA: " + reporteCaja.getFecha());
            i++;
            row = sheet.createRow(i);
            row.createCell(4).setCellValue("FECHA INICIO: " + reporteCaja.getFechaInicio());
            i++;
            row = sheet.createRow(i);
            row.createCell(4).setCellValue("FECHA FINAL: " + reporteCaja.getFechaFinal());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("DATOS GENERALES");
            row.createCell(1).setCellValue("COMPROBANTES EMITIDOS");
            row.createCell(2).setCellValue("RESUMEN DE VENTAS");
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("PERIODO DEL REPORTE: " + reporteCaja.getFechaInicio() + "A" + reporteCaja.getFechaFinal());
            row.createCell(1).setCellValue("FACTURAS EMITIDAS: " + reporteCaja.getFacturasEmitidas());
            row.createCell(2).setCellValue("VENTAS GRAVADAS CON 12%: " + reporteCaja.getTotal12());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("USUARIO: " + reporteCaja.getUsuario());
            row.createCell(1).setCellValue("FACTURAS ANULADAS: " + reporteCaja.getFacturasAnuladas());
            row.createCell(2).setCellValue("VENTAS GRAVADAS CON 0%: " + reporteCaja.getTotal0());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("CARGO: " + reporteCaja.getCargoUsuario());
            row.createCell(1).setCellValue("TOTAL: " + reporteCaja.getFacturasTotales());
            row.createCell(2).setCellValue("IVA TARIFA 12%: " + reporteCaja.getTotalIva());
            i++;
            row = sheet.createRow(i);
            row.createCell(2).setCellValue("TOTAL: " + reporteCaja.getTotal());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("CIERRE DE VENTAS AL CONTADO");
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("EFECTIVO");
            row.createCell(1).setCellValue("CHEQUE");
            row.createCell(2).setCellValue("T. CREDITO ");
            row.createCell(3).setCellValue("T. DEBITO");
            row.createCell(4).setCellValue("TRANSFERENCIAS");
            row.createCell(5).setCellValue("DEPOSITOS");
            row.createCell(6).setCellValue("CREDITOS");
            row.createCell(7).setCellValue("RETENCION");
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue(reporteCaja.getEfectivo());
            row.createCell(1).setCellValue(reporteCaja.getCheque());
            row.createCell(2).setCellValue(reporteCaja.getTarjetaCredito());
            row.createCell(3).setCellValue(reporteCaja.getTarjetaDebito());
            row.createCell(4).setCellValue(reporteCaja.getTransferencia());
            row.createCell(5).setCellValue(reporteCaja.getDeposito());
            row.createCell(6).setCellValue(reporteCaja.getCredito());
            i++;
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("TOTAL CAJA DIARIA");
            row.createCell(1).setCellValue(reporteCaja.getTotal());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("TOTAL EFECTIVO");
            row.createCell(1).setCellValue(reporteCaja.getEfectivo());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("TOTAL CHEQUES");
            row.createCell(1).setCellValue(reporteCaja.getCheque());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("TOTAL T. CREDITO");
            row.createCell(1).setCellValue(reporteCaja.getTarjetaCredito());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("TOTAL T. DEBITO");
            row.createCell(1).setCellValue(reporteCaja.getTarjetaDebito());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("TOTAL TRANSFERENCIAS");
            row.createCell(1).setCellValue(reporteCaja.getTransferencia());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("TOTAL DEPOSITOS");
            row.createCell(1).setCellValue(reporteCaja.getDeposito());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("TOTAL CREDITO");
            row.createCell(1).setCellValue(reporteCaja.getCredito());
            i++;
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("DINERO RECAUDADO");
            i++;
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("BILLETES");
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("CANTIDAD");
            row.createCell(1).setCellValue("DENOMINACION");
            row.createCell(2).setCellValue("TOTAL");
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue(reporteCaja.getCantidadBillete100());
            row.createCell(1).setCellValue(reporteCaja.getDenominacionBillete100());
            row.createCell(2).setCellValue(reporteCaja.getTotalBillete100());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue(reporteCaja.getCantidadBillete50());
            row.createCell(1).setCellValue(reporteCaja.getDenominacionBillete50());
            row.createCell(2).setCellValue(reporteCaja.getTotalBillete50());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue(reporteCaja.getCantidadBillete20());
            row.createCell(1).setCellValue(reporteCaja.getDenominacionBillete20());
            row.createCell(2).setCellValue(reporteCaja.getTotalBillete20());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue(reporteCaja.getCantidadBillete10());
            row.createCell(1).setCellValue(reporteCaja.getDenominacionBillete10());
            row.createCell(2).setCellValue(reporteCaja.getTotalBillete10());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue(reporteCaja.getCantidadBillete5());
            row.createCell(1).setCellValue(reporteCaja.getDenominacionBillete5());
            row.createCell(2).setCellValue(reporteCaja.getTotalBillete5());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue(reporteCaja.getCantidadBillete2());
            row.createCell(1).setCellValue(reporteCaja.getDenominacionBillete2());
            row.createCell(2).setCellValue(reporteCaja.getTotalBillete2());
            i++;
            row = sheet.createRow(i);
            ...
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("MONEDAS");
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("CANTIDAD");
            row.createCell(1).setCellValue("DENOMINACION");
            ...
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue(reporteCaja.getCantidadMoneda100());
            row.createCell(1).setCellValue(reporteCaja.getDenominacionMoneda100());
            row.createCell(2).setCellValue(reporteCaja.getTotalMoneda100());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue(reporteCaja.getCantidadMoneda50());
            row.createCell(1).setCellValue(reporteCaja.getDenominacionMoneda50());
            row.createCell(2).setCellValue(reporteCaja.getTotalMoneda50());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue(reporteCaja.getCantidadMoneda25());
            row.createCell(1).setCellValue(reporteCaja.getDenominacionMoneda25());
            row.createCell(2).setCellValue(reporteCaja.getTotalMoneda25());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue(reporteCaja.getCantidadMoneda10());
            row.createCell(1).setCellValue(reporteCaja.getDenominacionMoneda10());
            row.createCell(2).setCellValue(reporteCaja.getTotalMoneda10());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue(reporteCaja.getCantidadMoneda5());
            row.createCell(1).setCellValue(reporteCaja.getDenominacionMoneda5());
            row.createCell(2).setCellValue(reporteCaja.getTotalMoneda5());
            i++;
            row = sheet.createRow(i);
            ...
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("TOTAL DINERO RECAUDADO");
            row.createCell(1).setCellValue(reporteCaja.getTotalRecaudacion());
            i++;
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("DIFERENCIAS");
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("FALTANTE DE CAJA");
            row.createCell(1).setCellValue(reporteCaja.getFaltante());
            i++;
            row = sheet.createRow(i);
            row.createCell(0).setCellValue("SOBRANTE DE CAJA");
            row.createCell(1).setCellValue(reporteCaja.getSobrante());
