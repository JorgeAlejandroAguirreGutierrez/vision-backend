...
public class ReporteCajaService {
    ...
    public ByteArrayInputStream excel(String apodo, String fechaInicio, String fechaFinal, long empresaId) {
        try {
            ...
            row.createCell(6).setCellValue(reporteCaja.getRazonSocial());
            i++;
            row = sheet.createRow(i);
            row.createCell(6).setCellValue(reporteCaja.getNombreComercial());
            i++;
            row = sheet.createRow(i);
            row.createCell(6).setCellValue(reporteCaja.getNombreReporte());
            i++;
            row = sheet.createRow(i);
            row.createCell(6).setCellValue("FECHA: " + reporteCaja.getFecha());
            i++;
            row = sheet.createRow(i);
            row.createCell(6).setCellValue("FECHA INICIO: " + reporteCaja.getFechaInicio());
            i++;
            row = sheet.createRow(i);
            row.createCell(6).setCellValue("FECHA FINAL: " + reporteCaja.getFechaFinal());
            i++;
            row = sheet.createRow(i);
            ...
            row.createCell(2).setCellValue("VENTAS GRAVADAS CON 12%" + "A" + reporteCaja.getTotal12());
            i++;
            row = sheet.createRow(i);
            ...
            row.createCell(2).setCellValue(reporteCaja.getCheque());
            row.createCell(3).setCellValue(reporteCaja.getTarjetaCredito());
            row.createCell(4).setCellValue(reporteCaja.getTarjetaDebito());
            row.createCell(5).setCellValue(reporteCaja.getTransferencia());
            row.createCell(6).setCellValue(reporteCaja.getDeposito());
            row.createCell(7).setCellValue(reporteCaja.getCredito());
            i++;
            i++;
            row = sheet.createRow(i);
