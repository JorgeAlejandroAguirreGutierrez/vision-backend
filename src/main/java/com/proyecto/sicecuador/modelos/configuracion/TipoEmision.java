...
public class TipoEmision extends Entidad {
    ...
    public TipoEmision(long id){
        super(id);
    }

    public TipoEmision(String codigo, String codigoSri, String descripcion, String estado) {
        super(codigo);
        this.codigoSri=codigoSri;
        this.descripcion=descripcion;
        this.estado=estado;
    }
    public TipoEmision(List<String> datos){
