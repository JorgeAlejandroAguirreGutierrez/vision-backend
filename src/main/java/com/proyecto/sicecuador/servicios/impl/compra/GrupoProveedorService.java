...
public class GrupoProveedorService implements IGrupoProveedorService {
    ...
    public GrupoProveedor crear(GrupoProveedor grupoProveedor) {
    	...
    	Optional<String>codigo=Util.generarCodigo(Constantes.tabla_grupo_proveedor);
    	if (codigo.isEmpty()) {
    ...
    public void importar(MultipartFile archivoTemporal) {
        try {
            ...
            for (List<String> datos: info) {
                GrupoProveedor grupoProveedor = new GrupoProveedor(datos);
                gruposProveedores.add(grupoProveedor);
            }
