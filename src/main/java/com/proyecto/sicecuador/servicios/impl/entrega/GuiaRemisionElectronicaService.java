...
public class GuiaRemisionElectronicaService implements IGuiaRemisionElectronicaService {
	...
	private InfoAdicional crearInfoAdicional(GuiaRemision guiaRemision) {
		...
		if(!guiaRemision.getFactura().getCliente().getTelefonos().isEmpty()) telefono = guiaRemision.getFactura().getCliente().getTelefonos().get(0).getNumero();
		String celular = Constantes.vacio;
		if(!guiaRemision.getFactura().getCliente().getTelefonos().isEmpty()) celular = guiaRemision.getFactura().getCliente().getCelulares().get(0).getNumero();
		String correo = Constantes.vacio;
		if(!guiaRemision.getFactura().getCliente().getCorreos().isEmpty()) correo = guiaRemision.getFactura().getCliente().getCorreos().get(0).getEmail();
