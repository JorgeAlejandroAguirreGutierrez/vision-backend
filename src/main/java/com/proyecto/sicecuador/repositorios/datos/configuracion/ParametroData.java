...
public class ParametroData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            parametros.add(new Parametro("PAR49", "PERIODICIDAD", "QUICENAL", "", "Q"));
            parametros.add(new Parametro("PAR50", "PERIODICIDAD", "DIARIO", "", "D"));
            parametros.add(new Parametro("PAR51", "TIPO AMORTIZACION", "ALEMANA", "", "AL"));
            parametros.add(new Parametro("PAR52", "TIPO AMORTIZACION", "FRANCESA", "", "FR"));
