...
public class ClienteData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            clientes.add(new Cliente("CLI011907000001", "C", "1768038860001", "CLIENTE A", true, true, false, new PuntoVenta(1),
                    new GrupoCliente(1), new TipoContribuyente(1), direccion, financiamiento, new Genero(2),
                    new EstadoCivil(2), new CategoriaCliente(1), new OrigenIngreso(1)));
            ...
            clientes.add(new Cliente("CLI011908000002", "C", "1160000240001", "CLIENTE B", true, true, false, new PuntoVenta(1),
                    new GrupoCliente(2), new TipoContribuyente(2), direccion, financiamiento, new Genero(1),
                    new EstadoCivil(1), new CategoriaCliente(1), new OrigenIngreso(1)));
            ...
            clientes.add(new Cliente("CLI011909000003", "C", "9999999999999", "CLIENTE CF", true, true, false, new PuntoVenta(1),
