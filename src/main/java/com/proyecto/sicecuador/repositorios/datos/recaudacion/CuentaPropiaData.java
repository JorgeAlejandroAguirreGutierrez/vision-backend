...
public class CuentaPropiaData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            cuentas_propias.add(new CuentaPropia("CP000001","0000000001", new Banco(1)));
            cuentas_propias.add(new CuentaPropia("CP000002","0000000002", new Banco(1)));
            cuentas_propias.add(new CuentaPropia("CP000003","0000000003", new Banco(2)));
            cuentas_propias.add(new CuentaPropia("CP000004","0000000004", new Banco(2)));
