...
public class CaracteristicaData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            caracteristicas.add(new Caracteristica("CAR011909000009-1", "ESCRITORIO GERENCIAL-1", "", "ACER", "2019", "000000009B-1", new Producto(9), new Bodega(2)));
            caracteristicas.add(new Caracteristica("CAR011909000009-1", "ESCRITORIO GERENCIAL-2", "", "ACER", "2019", "000000009B-2", new Producto(9), new Bodega(2)));
            caracteristicas.add(new Caracteristica("CAR011909000009-1", "ESCRITORIO GERENCIAL-3", "", "ACER", "2019", "000000009B-3", new Producto(9), new Bodega(2)));
            caracteristicas.add(new Caracteristica("CAR011909000009-1", "ESCRITORIO GERENCIAL-4", "", "ACER", "2019", "000000009B-4", new Producto(9), new Bodega(2)));
            caracteristicas.add(new Caracteristica("CAR011909000009-1", "ESCRITORIO GERENCIAL-5", "", "ACER", "2019", "000000009B-5", new Producto(9), new Bodega(2)));
            caracteristicas.add(new Caracteristica("CAR011909000009-1", "ESCRITORIO GERENCIAL-6", "", "ACER", "2019", "000000009B-6", new Producto(9), new Bodega(2)));
            caracteristicas.add(new Caracteristica("CAR011909000009-1", "ESCRITORIO GERENCIAL-7", "", "ACER", "2019", "000000009B-7", new Producto(9), new Bodega(2)));
