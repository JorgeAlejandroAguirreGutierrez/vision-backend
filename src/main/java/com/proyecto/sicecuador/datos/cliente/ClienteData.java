...
public class ClienteData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            clientes.add(new Cliente("CLI011907000001", "1768038860001", "CLIENTE A", true, "ACTIVO", false, new TipoIdentificacion(1), new Estacion(1),
            ...
            clientes.add(new Cliente("CLI011908000002", "1160000240001", "CLIENTE B", true, "ACTIVO", false, new TipoIdentificacion(1), new Estacion(1),
            ...
            clientes.add(new Cliente("CLI011909000003", "9999999999999", "CLIENTE CF", true, "ACTIVO", false, new TipoIdentificacion(4), new Estacion(1),
