...
public class ClienteData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            clientes.add(new Cliente("CLI011907000001", "1768038860001", "CLIENTE A", Constantes.no, Constantes.si, Constantes.activo, "CARRERA 1 # 1-1", "CASA","CERCA A LA IGLESIA NOE", -1.6719601146175827, -78.65041698970857, new TipoIdentificacion(1), new Estacion(1),
            ...
            clientes.add(new Cliente("CLI011908000002", "1160000240001", "CLIENTE B", Constantes.no, Constantes.si, Constantes.activo, "CARRERA 2 # 2-2", "TRABAJO","CERCA A LA IGLESIA PATRIA", -1.6719601146175927, -78.65041698970957, new TipoIdentificacion(1), new Estacion(1),
            ...
            clientes.add(new Cliente("CLI011909000003", "9999999999999", "CLIENTE CF", Constantes.no, Constantes.si, Constantes.activo, "CARRERA 3 # 3-3", "CASA","CERCA A LA IGLESIA DEL NORTE", -1.6719601146175427, -78.65041698970457, new TipoIdentificacion(4), new Estacion(1),
