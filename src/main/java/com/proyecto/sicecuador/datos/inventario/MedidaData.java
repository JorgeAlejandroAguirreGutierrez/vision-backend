...
public class MedidaData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            medidas.add(new Medida("MED202301000002", "UNIDAD", "MITAD", "MIT", Constantes.activo, new Empresa(2)));
            medidas.add(new Medida("MED202301000003", "UNIDAD", "CUARTO", "CUA", Constantes.activo, new Empresa(2)));
            medidas.add(new Medida("MED202301000004", "UNIDAD", "CAJAX10", "C10", Constantes.activo, new Empresa(2)));
            medidas.add(new Medida("MED202301000005", "UNIDAD", "CAJAX12", "C12", Constantes.activo, new Empresa(2)));
            medidas.add(new Medida("MED202301000006", "UNIDAD", "CAJAX20", "C20", Constantes.activo, new Empresa(2)));
            medidas.add(new Medida("MED202301000007", "UNIDAD", "SIXPACK", "SIX", Constantes.activo, new Empresa(2)));
            medidas.add(new Medida("MED202301000008", "UNIDAD", "JABA", "JX12", Constantes.activo, new Empresa(2)));
            medidas.add(new Medida("MED202301000009", "PESO", "ARROBA", "@", Constantes.activo, new Empresa(2)));
            ...
            medidas.add(new Medida("MED202301000014", "PESO", "MILIGRAMO", "MG", Constantes.activo, new Empresa(2)));
            ...
            medidas.add(new Medida("MED202301000017", "PESO", "QUINTAL", "CWT", Constantes.inactivo, new Empresa(2)));
            ...
            medidas.add(new Medida("MED202301000020", "PESO", "TONELADA", "TON", Constantes.activo, new Empresa(2)));
            ...
            medidas.add(new Medida("MED202301000023", "VOLUMEN", "CUARTO DE GALÓN", "QT", Constantes.activo, new Empresa(2)));
            ...
            medidas.add(new Medida("MED202301000029", "VOLUMEN", "TAZA", "CUP", Constantes.activo, new Empresa(2)));
