...
public class BodegaData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            bodegas.add(new Bodega("BOD022301000001","BODEGA CENTRAL", "BC001",Constantes.activo, new Empresa(2)));
            bodegas.add(new Bodega("BOD022301000002","BODEGA LOCAL NORTE", "BC001",Constantes.activo, new Empresa(2)));
            bodegas.add(new Bodega("BOD022301000003","BODEGA LOCAL SUR", "BL002",Constantes.activo, new Empresa(2)));
            rep.saveAll(bodegas);
        }
    }
}
