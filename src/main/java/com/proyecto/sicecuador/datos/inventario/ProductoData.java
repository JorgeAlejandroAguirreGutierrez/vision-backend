    ...
    private IProductoRepository rep;
        ...
        public void run(ApplicationArguments args) throws Exception {
            ...
            if (!ant.isPresent()) {
                ...
                productos.add(new Producto("PRO012307000001", "CELULARES", Constantes.no, Constantes.activo, new CategoriaProducto(1), new GrupoProducto(1), new TipoGasto(1), new Impuesto(1), new Medida(1), new Proveedor(1), new Empresa(1), Collections.emptyList(), Collections.emptyList()));
                productos.add(new Producto("PRO012307000002", "REFRIGERADOR", Constantes.no, Constantes.activo, new CategoriaProducto(1), new GrupoProducto(1), new TipoGasto(1), new Impuesto(2), new Medida(1), new Proveedor(1), new Empresa(1), Collections.emptyList(), Collections.emptyList()));
                productos.add(new Producto("PRO012307000003", "TELEVISOR", Constantes.no, Constantes.activo, new CategoriaProducto(1), new GrupoProducto(1), new TipoGasto(1), new Impuesto(1), new Medida(1), new Proveedor(1), new Empresa(1), Collections.emptyList(), Collections.emptyList()));
                productos.add(new Producto("PRO012307000004", "CAMAS", Constantes.no, Constantes.activo, new CategoriaProducto(1), new GrupoProducto(1), new TipoGasto(1), new Impuesto(2), new Medida(1), new Proveedor(1), new Empresa(1), Collections.emptyList(), Collections.emptyList()));
