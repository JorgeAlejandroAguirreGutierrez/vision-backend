...
public class UsuarioData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            usuarios.add(new Usuario("USU202301000002", "0123456789", "JALEJANDRO", "JORGE ALEJANDRO", "032945188", "0931248588", "alejandro@gmail.com", "827ccb0eea8a706c4c34a16891f84e7b", "827ccb0eea8a706c4c34a16891f84e7b", "", avatarBytesAlejandro, Constantes.no, "PRIMERA PREGUNTA", "PRIMERA RESPUESTA", Constantes.activo, new Perfil(1), new Estacion(2)));
            usuarios.add(new Usuario("USU202301000003", "0502685969", "JHIDALGO", "JORGE HIDALGO", "032945122", "09312485677", "gatosohidalgo@gmail.com", "827ccb0eea8a706c4c34a16891f84e7b", "827ccb0eea8a706c4c34a16891f84e7b", "", avatarBytesJorge, Constantes.no, "PRIMERA PREGUNTA", "PRIMERA RESPUESTA", Constantes.activo, new Perfil(1), new Estacion(6)));
