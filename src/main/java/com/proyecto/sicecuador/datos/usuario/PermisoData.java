...
public class PermisoData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            permisos.add(new Permiso("PER202301000028", "CAJA_BANCOS", "CREAR", Constantes.si, Constantes.activo, new Perfil(1)));
            permisos.add(new Permiso("PER202301000029", "CUENTAS_COBRAR", "CREAR", Constantes.si, Constantes.activo, new Perfil(1)));
            permisos.add(new Permiso("PER202301000030", "CUENTAS_PAGAR", "CREAR", Constantes.si, Constantes.activo, new Perfil(1)));
            permisos.add(new Permiso("PER202301000031", "ACTIVOS_FIJOS", "CREAR", Constantes.si, Constantes.activo, new Perfil(1)));
            ...
            permisos.add(new Permiso("PER202301000035", "TALENTO_HUMANO", "CREAR", Constantes.si, Constantes.activo, new Perfil(1)));
            ...
            permisos.add(new Permiso("PER202301000046", "CONFIGURACIONES", "UBICACIÓN", Constantes.si, Constantes.activo, new Perfil(1)));
            permisos.add(new Permiso("PER202301000047", "CONFIGURACIONES", "ESTADO CIVIL", Constantes.si, Constantes.activo, new Perfil(1)));
            permisos.add(new Permiso("PER202301000048", "CONFIGURACIONES", "IMPUESTOS", Constantes.si, Constantes.activo, new Perfil(1)));
            permisos.add(new Permiso("PER202301000049", "CONFIGURACIONES", "TIPOS DE PAGO", Constantes.si, Constantes.activo, new Perfil(1)));
            permisos.add(new Permiso("PER202301000050", "CONFIGURACIONES", "TIPOS DE RETENCIÓN", Constantes.si, Constantes.activo, new Perfil(1)));
            permisos.add(new Permiso("PER202301000051", "CONFIGURACIONES", "GENEROS", Constantes.si, Constantes.activo, new Perfil(1)));
            permisos.add(new Permiso("PER202301000052", "CONFIGURACIONES", "IMPORTACIONES", Constantes.si, Constantes.activo, new Perfil(1)));
            permisos.add(new Permiso("PER202301000053", "CONFIGURACIONES", "EXPORTACIONES", Constantes.si, Constantes.activo, new Perfil(1)));
            permisos.add(new Permiso("PER202301000054", "ESTADISTICAS", "DASHBOARD", Constantes.si, Constantes.activo, new Perfil(1)));
            permisos.add(new Permiso("PER202301000055", "ORGANISMOS_CONTROL", "CREAR", Constantes.si, Constantes.activo, new Perfil(1)));
