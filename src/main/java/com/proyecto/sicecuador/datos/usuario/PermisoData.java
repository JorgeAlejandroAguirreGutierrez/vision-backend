...
public class PermisoData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            permisos.add(new Permiso("PER202301000060", "CLIENTES", "ORIGEN DE INGRESOS", Constantes.si, Constantes.activo, new Perfil(2)));
            permisos.add(new Permiso("PER202301000061", "CLIENTES", "PLAZOS DE CRÉDITO", Constantes.si, Constantes.activo, new Perfil(2)));
            permisos.add(new Permiso("PER202301000062", "CLIENTES", "CALIFICACIÓN DE CLIENTES", Constantes.si, Constantes.activo, new Perfil(2)));
            ...
            permisos.add(new Permiso("PER202301000065", "COMPRAS", "GRUPOS PROVEEDORES", Constantes.si, Constantes.activo, new Perfil(2)));
            permisos.add(new Permiso("PER202301000066", "VENTAS", "FACTURAS", Constantes.si, Constantes.activo, new Perfil(2)));
            permisos.add(new Permiso("PER202301000067", "VENTAS", "PEDIDOS", Constantes.si, Constantes.activo, new Perfil(2)));
            permisos.add(new Permiso("PER202301000068", "VENTAS", "PROFORMAS", Constantes.si, Constantes.activo, new Perfil(2)));
            permisos.add(new Permiso("PER202301000069", "VENTAS", "EGRESOS", Constantes.si, Constantes.activo, new Perfil(2)));
            permisos.add(new Permiso("PER202301000070", "VENTAS", "TRANSPORTISTAS", Constantes.si, Constantes.activo, new Perfil(2)));
            permisos.add(new Permiso("PER202301000071", "VENTAS", "VEHICULO TRANSPORTE", Constantes.si, Constantes.activo, new Perfil(2)));
            ...
            permisos.add(new Permiso("PER202301000075", "INVENTARIOS", "PROMOCIONES", Constantes.si, Constantes.activo, new Perfil(2)));
            permisos.add(new Permiso("PER202301000076", "INVENTARIOS", "PROVEEDORES DE PRODUCTOS", Constantes.si, Constantes.activo, new Perfil(2)));
            permisos.add(new Permiso("PER202301000077", "INVENTARIOS", "TRANSFERENCIAS DE BODEGA", Constantes.si, Constantes.activo, new Perfil(2)));
            permisos.add(new Permiso("PER202301000078", "INVENTARIOS", "BODEGAS", Constantes.si, Constantes.activo, new Perfil(2)));
