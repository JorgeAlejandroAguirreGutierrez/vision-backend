...
public class EstacionData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            estaciones.add(new Estacion("ESN202301000005", "", "CONTADOR", "PC", "192.168.1.5", Constantes.no, Constantes.activo, new Regimen(2), new Establecimiento(2)));
            estaciones.add(new Estacion("ESN202301000006", "", "TESORERO", "PC", "192.168.1.7", Constantes.no, Constantes.activo, new Regimen(3), new Establecimiento(3)));
