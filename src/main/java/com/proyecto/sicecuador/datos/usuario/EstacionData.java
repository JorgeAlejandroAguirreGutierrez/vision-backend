...
public class EstacionData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            estaciones.add(new Estacion("ESN202301000004", "004", "VENTAS1", "TABLET", "192.168.1.4", Constantes.si, Constantes.activo, null, new Establecimiento(2)));
            estaciones.add(new Estacion("ESN202301000005", "005", "CONTADOR", "PC", "192.168.1.5", Constantes.no, Constantes.activo, new Regimen(2), new Establecimiento(2)));
            estaciones.add(new Estacion("ESN202301000006", "006", "TESORERO", "PC", "192.168.1.7", Constantes.no, Constantes.activo, new Regimen(3), new Establecimiento(3)));
            estaciones.add(new Estacion("ESN202301000007", "007", "VENTAS2", "PORTATIL", "192.168.1.6", Constantes.si, Constantes.activo, new Regimen(1), new Establecimiento(3)));
