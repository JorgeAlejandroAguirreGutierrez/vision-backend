...
public class MenuOpcionData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            opciones.add(new MenuOpcion("MEN202305000049", "INVENTARIOS", "GRUPOS DE PRODUCTOS","CREAR", Constantes.si, "grupo_producto", "GRP", Constantes.activo));
            ...
            opciones.add(new MenuOpcion("MEN202305000063", "VENTAS", "RECAUDACIÓN","CREAR", Constantes.no, "cuenta_propia", "CTP", Constantes.activo));
