...
public class TipoRetencionData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            tiposRetenciones.add(new TipoRetencion("TRE00000007", "RENTA", "BIEN", "303", "HONORARIOS PROFESIONALES Y DEMAS PAGOS POR SERVICIOS RELACIONADOS CON EL TITULO PROFESIONAL", 10, Constantes.activo));
            tiposRetenciones.add(new TipoRetencion("TRE00000008", "RENTA", "BIEN", "304", "SERVICIOS PREDOMINA EL INTELECTO NO RELACIONADOS CON EL TITULO PROFESIONAL", 5, Constantes.activo));
            ...
            tiposRetenciones.add(new TipoRetencion("TRE00000013", "RENTA", "BIEN", "307", "SERVICIOS PREDOMINA LA MANO DE OBRA", 2, Constantes.activo));
            tiposRetenciones.add(new TipoRetencion("TRE00000014", "RENTA", "BIEN", "308", "UTILIZACION O APROVECHAMIENTO DE LA IMAGEN O RENOMBRE", 10, Constantes.activo));
            tiposRetenciones.add(new TipoRetencion("TRE00000015", "RENTA", "BIEN", "309", "SERVICIOS PRESTADOS POR MEDIOS DE COMUNICACION Y AGENCIAS DE PUBLICIDAD", 1.75, Constantes.activo));
            tiposRetenciones.add(new TipoRetencion("TRE00000016", "RENTA", "BIEN", "310", "SERVICIO DE TRANSPORTE PRIVADO DE PASAJEROS O TRANSPORTE PUBLICO O PRIVADO DE CARGA", 1, Constantes.activo));
