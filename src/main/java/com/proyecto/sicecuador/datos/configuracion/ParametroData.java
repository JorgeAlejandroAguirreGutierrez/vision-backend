...
public class ParametroData implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        if (!ant.isPresent()) {
            ...
            parametros.add(new Parametro("PAR44", "TRANSACCION", "DEPOSITO", "", "DP", Constantes.activo));
            parametros.add(new Parametro("PAR45", "TRANSACCION", "TRANSFERENCIA", "", "TF", Constantes.activo));
